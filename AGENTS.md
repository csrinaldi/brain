...
- [ADR-0032](brain/project/decisions/adr-0032-graph-block-declared-by-its-tag.md) — A graph block is declared by its fence tag: unspoofability outranks the rendered-artifact rule, and the tag is only half the fix
