...
> **This is a draft under `openspec/changes/issue-396/brain-drafts/`.** It is not in
> `brain/project/decisions/` and carries no force until a human promotes it. ADR number
> 0027 is claimed provisionally: 0026 is the highest present, so 0027 is the first free
> slot at the time of writing — re-verify before promotion.
