...
> **relates to:** ADR-0015 (enforcement honesty), ADR-0020 (reviewActors/approvalActors), ADR-0026 (tiers), ADR-0031 (attribution is a claim), ADR-0033 (cold-review transport), ADR-0034 (`mrAutoMerge`, the memory lane), ADR-0036 (fresh-consumer done); epic #1121 ruling 5; #1107, #1133, #1134
...
> Committing them is the signature. The number `0037` was free on `origin/main` at `826cbbf0`
> (highest: 0036). The companion amendment to `agent-authorities.md` Tier 3 is
> `agent-authorities-tier3.draft.md` in the same directory; promote this ADR first, because
> the amendment cites it by number.
