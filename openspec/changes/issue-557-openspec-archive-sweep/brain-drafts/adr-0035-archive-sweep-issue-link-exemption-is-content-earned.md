...
> **status:** proposed — pending human promotion | **date:** 2026-09-23 | **owner:** @crinaldi
> **relates to:** ADR-0034 L1 (the memory lane — the precedent), ADR-0014 (workflow governance), ADR-0016 (CI context normalization)
...
> Committing them is the signature. The number `0035` was free at the tracker head (highest: 0034).
