...
> line in the body in place — but the sentence describing that act was never updated. This
...
amendment: 4
issue: 973
home-summary: erratum — Amendment 3's sentence claiming the body and Amendments 1-2 were not rewritten is corrected; the same act annotated them in place under R6 as amended (option A), #973
...
sentence said the body and Amendments 1-2 were not rewritten, although the same act had annotated
them in place.]** No line of this ADR runs a script with a literal `npm run`, so the decision
reads the same.
```
