...
> body and Amendments 1-2 above it were "not rewritten (ruling R6 on #961)". That was drafted under
> R6 as first ratified. The maintainer amended R6 to option A on 2026-09-14 (issue #961 comment,
> confirmed on PR #966) before Amendment 3 promoted, and the same act annotated every superseded
> line in the body and Amendments 1-2 in place — but the sentence describing that act was never
> updated. This corrects only that sentence. See
> `openspec/changes/issue-973-adr-r6-erratum/proposal.md`.

```brain-amendment/1
target: brain/project/decisions/adr-0017-memory-format-owned-by-brain.md
amendment: 4
issue: 973
home-summary: erratum — Amendment 3 said the body and Amendments 1-2 were not rewritten, but its own promotion had annotated them in place under ruling R6 on #961 as amended (option A); that sentence is rewritten, #973
body: ## Amendment 4 — erratum: Amendment 3 called the body and Amendments 1-2 untouched; they were annotated in place (issue #973)
body-end: ### Notes for the promoter
```

## Amendment 4 — erratum: Amendment 3 called the body and Amendments 1-2 untouched; they were annotated in place (issue #973)
...
sentence was drafted under ruling R6 as first ratified — an appended amendment, body untouched. The
maintainer amended R6 to option A on 2026-09-14 (issue #961 comment, confirmed on PR #966), and
Amendment 3's own promotion (PR #972) applied that ruling: every line of the body and of
...
The anchor is the two-line sentence at `adr-0017-memory-format-owned-by-brain.md:471-472`, the only
...
```amend-replace
Every superseded line in the body and in Amendments 1-2 above is annotated in place under ruling R6
