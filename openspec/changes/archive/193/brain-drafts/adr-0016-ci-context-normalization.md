...
`prView()` returns `labels: [], body: ''` on *any* failure, conflating "none" with "couldn't
...
*strengthens* ADR-0015's Epic Invariant: after this change the only provider-aware code is
