...
> **Tier 2 draft.** Written by an agent for #617; promoted with
> `npm run brain:promote -- openspec/changes/issue-617-supersede-adr-0006/brain-drafts/adr-0030-distribution-scoped-registry-package.md`.
> The commit is the signature (ADR-0028) and it is not the agent's to make.
>
> **Promote the ADR-0006 amendment draft in the same change alongside it** —
> superseding is two acts, and this is only the first.
