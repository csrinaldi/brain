...
# Spec — preflight-runbook (issue 435)

## REQ-435-P1 — The runbook refuses a shallow clone before anything else
...
## REQ-435-P2 — Two scanners, not one
...
## REQ-435-P3 — Expected benign hits are enumerated
...
## REQ-435-P4 — Rotation is the remedy, and it is ordered first
...
## REQ-435-P5 — The §2b decision is forced, not assumed
...
## REQ-435-P6 — The agent's own pass is recorded as insufficient
