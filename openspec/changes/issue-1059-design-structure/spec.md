...
#### Scenario: the graph holds four nodes, two of which declare a track
...
#### Scenario: a change's `tasks.md` declares a slice plan
...
#### Scenario: a change declares no plan
...
#### Scenario: an epic is selected and three open issues declare it as their parent
...
#### Scenario: no open issue declares the selected one as its parent
...
#### Scenario: a change declares no slice plan
