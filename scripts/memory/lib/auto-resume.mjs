// scripts/memory/lib/auto-resume.mjs — isolation-wrapped feature-resume helper.
//
...
//   Default: spawnSync(process.execPath, ['scripts/memory/cli.mjs', 'feature-resume'],
//             { cwd: root, encoding: 'utf8' })

import { spawnSync } from 'node:child_process';

/**
 * Default subprocess runner — spawns `node scripts/memory/cli.mjs feature-resume`
...
function defaultRunner(root) {
  return spawnSync(
    process.execPath,
    ['scripts/memory/cli.mjs', 'feature-resume'],
    { cwd: root, encoding: 'utf8' },
  );
}
