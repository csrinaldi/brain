#!/usr/bin/env node
// scripts/vcs/cli.mjs — vcs.provider dispatcher.
//
// Reads vcs.provider from brain.config.json (or VCS_PROVIDER env override) and
// delegates to ./providers/<provider>.mjs. Mirrors scripts/memory/cli.mjs, but
...
//                     node scripts/vcs/cli.mjs <verb> '<json-args>'
//                     e.g. node scripts/vcs/cli.mjs issue-list '{"state":"open"}'
