...
>
> ```bash
> npm i -D "git+https://github.com/csrinaldi/brain.git#v1.6.0"
> ```
...
```bash
npm run brain:upgrade -- v1.6.0             # install a newer tag, copy managed paths
npm run brain:upgrade -- v1.6.0 --dry-run   # preview what would change
```
