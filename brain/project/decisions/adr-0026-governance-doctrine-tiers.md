...
**Status**: Accepted · **amended 11/08/2026** (Amendments 1-4 — see below) · **Amendments 5 (#581) and 6 (#94) PENDING SIGNATURE**  
...
| `required_approving_review_count` | **0** | **1** | **1** | **[Added by Amendment 6 (#94), PENDING SIGNATURE — the platform review count is tier-derived; see Amendment 6 for why `regulated` is 1 and not 2.]** |
...
**Status**: PENDING SIGNATURE — drafted 13/08/2026 on the maintainer's decision of the same
date. Not in force until signed. The code change it records is in the same pull request; if
this amendment is refused, that change goes with it.
...
since omission hands the decision to the provider default) and carries the tier's value, for all
three tiers. Two consecutive runs send byte-identical protection. A fourth test pins that the
armed count and its tier are reported.
