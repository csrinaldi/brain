...
- [ADR-0014](project/decisions/adr-0014-workflow-governance.md) — Workflow governance: enforce load-bearing invariants server-side (**Amendment 1, 15/09/2026** — the memory-dump proxy's script is now `brain:memory:share`; the bare name stays as a repo-only alias and the invariants are unchanged, #961)
