...
- [ADR-0011](project/decisions/adr-0011-feature-scoped-working-memory.md) — Feature-scoped working memory: branch-local resume.md (**Amendment 1, 15/09/2026** — the export this ADR cites is now `brain:memory:share`; the bare name stays as a repo-only alias and the decision is unchanged, #961)
