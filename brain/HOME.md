...
- [ADR-0027](project/decisions/adr-0027-upgrade-rollback-is-restorable-not-atomic.md) — `brain:upgrade` rollback is restorable, not atomic: restates #396's exit criterion from "never half-applied" to "restorable to byte-identical", and names each residual gap instead of implying coverage
