...
- [ADR-0033](project/decisions/adr-0033-cold-review-transport.md) — The cold review runs as a spawned subagent: the transport is a stage engine, and the producer never holds a credential
