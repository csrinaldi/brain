...
- [ADR-0034](project/decisions/adr-0034-memory-travels-on-its-own-lane.md) — Memory travels on its own lane: records reach `main` on their own pull request, never the feature's
