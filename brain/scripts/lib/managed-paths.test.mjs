...
// issue #256, B2 Half 1, REQ-B2-4: the emitted AGENTS.md must travel with
// brain on upgrade, as an exact literal — repo root, outside every existing
// glob, regenerated by antigravity.mjs#init.
test('managed includes AGENTS.md (exact literal, issue #256 B2, REQ-B2-4)', () => {
  assert.ok(
